...
Exp_Instructions::Exp_Instructions(const std::string & op, const int& rt, const int& rd)
    : Instructions(op)
{
...
std::string Exp_Instructions::MachineCodeString(machineFormat some) const {
    ...
    std::string returnString {Instructions::MachineCodeString(machineFormat::Binary) + zero_5.to_string() + Exp_Instructions::getRt() + 
                                Exp_Instructions::getRd() + zero_5.to_string() + zero_6.to_string()};
